...
func CheckImageFormat(file string) (int, error) {
	...
	if buf[0] == 0xff && buf[1] == 0xd8 && buf[2] == 0xff { // jpg
		return IMAGE_TYPE_JPEG, nil
	...
	return IMAGE_TYPE_UNKNOWN, fmt.Errorf("unknown image format")
}
